...
DOWNLOAD
========
* A demo running on Google's App Engine (GAE) can be found here: https://crococrypt-querl.appspot.com
...
* For a standalone binary package using Jetty 9 go to the release tab: https://github.com/fhissen/CrococryptQuerl/releases
